...
//	@Override
    public void onSensorChanged(SensorEvent event) {
        if(SimpleSnakeActivity.GAME_SCORE ==1)
        {surf.setSomeText("Odessa");}
        if(SimpleSnakeActivity.GAME_SCORE ==2)
        {surf.setSomeText("Lublin");}
        if(SimpleSnakeActivity.GAME_SCORE ==3)
        {surf.setSomeText("Kherson");}
        if(SimpleSnakeActivity.GAME_SCORE ==4)
        {surf.setSomeText("St. Peterburg");}
        if(SimpleSnakeActivity.GAME_SCORE ==5)
        {surf.setSomeText("Voronezh");}
        if(SimpleSnakeActivity.GAME_SCORE ==6)
        {surf.setSomeText("Kharkiv");}
        if(SimpleSnakeActivity.GAME_SCORE ==7)
        {surf.setSomeText("Kiev");}
        if(SimpleSnakeActivity.GAME_SCORE ==8)
        {surf.setSomeText("Dnepropetrovsk");}
        if(SimpleSnakeActivity.GAME_SCORE ==9)
        {surf.setSomeText("Lviv");}
